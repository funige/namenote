...
* Windowsの筆圧について
　大変申し訳ないのですが、現在フレームワークのバグのため、ワコムのタブレットを使っている場合
　「デジタルインク」オンのとき -> 筆圧は使えるが、メニューが反応しない（マウスで操作は可能）
　「デジタルインク」オフのとき -> 筆圧は使えないが、メニューは動作する
　という状況になっています。申し訳有りません。

　来月の更新でメニューの実装を見直して対応する予定です。
